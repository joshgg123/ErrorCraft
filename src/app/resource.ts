...
export const loader = new Loader([Resources.mapchip, Resources.bombaAgua,Resources.HeroSpriteSheetPng, Resources.coin, Resources.pasto]); // Agrega todos los recursos aquí